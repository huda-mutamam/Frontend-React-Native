...
const FoodSuccessScreen = ({ route, navigation }) => {
  const { orderId = 'N/A', total = '0' } = route.params || {};
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.successContainer}>
          ...
          <View style={styles.iconBackground}>
            <MaterialCommunityIcons name="food-takeout-box" size={80} color="#FFFFFF" />
          </View>
          <Text style={styles.successTitle}>Pesanan Diterima!</Text>
          <Text style={styles.successSubtitle}>
            Makanan Anda sedang disiapkan oleh restoran dan akan segera diantar.
          </Text>
        </View>
        ...
        <View style={styles.detailsCard}>
          ...
          <View style={styles.detailRow}>
            <MaterialCommunityIcons name="receipt-text-check-outline" size={22} color="#7F8C8D" />
...
const styles = StyleSheet.create({
  ...
  iconBackground: {
    ...
    height: 120,
    borderRadius: 60,
    backgroundColor: '#D32F2F', // Warna merah khas Food
    justifyContent: 'center',
    alignItems: 'center',
    marginBottom: 20,
    elevation: 5,
...
export default FoodSuccessScreen;